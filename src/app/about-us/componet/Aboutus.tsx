...
const Aboutus = () => {
  const styles = {
    mainer: "h-1/2 flex flex-col justify-center items-center bg-black mb-5",
    maint: "cursor-none ",
    cursur:
      "bg-red-500 h-8 w-8 rounded-full fixed top-0 left-0 pointer-events-none",
    cursurHidden: "hidden",
  };
      ...
      <section className="h-screen">
        <div className={styles.mainer}>
          <div className={styles.maint}>
            <motion.div
              className={isInH1 ? styles.cursur : styles.cursurHidden}
              variants={variants}
            ...
            <h1
              ...
              className="text-3xl font-bold text-white sm:text-2xl md:text-5xl"
            >
              About Us
            </h1>
          </div>
