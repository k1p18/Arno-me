              ...
              >
                <div className="rounded-xl overflow-hidden duration-300 relative hover:-translate-y-1">
                  <img
                    ...
                    loading="lazy"
                  />
                  <div className="absolute top-0 left-0 right-0 bottom-0 rounded-xl bg-black  bg-opacity-70 dark:bg-opacity-70 backdrop-blur scale-90 opacity-0 flex flex-col justify-center items-center transition duration-300 text-center hover:scale-100 hover:opacity-100 p-4">
