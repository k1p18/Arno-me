...
const Workrecord = () => {
  return (
    <>
      <section className="ezy__portfolio8 light py-14 md:py-24 bg-black  text-white">
        <div className="container px-4 mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-6 mx-auto ">
            {workList.map((worklist, i) => (
              <div className="col-span-1" key={i}>
                <div className="relative bg-white shadow-xl dark:bg-slate-800 hover:-translate-y-1 transition duration-300 rounded-xl">
                  <div className="bg-blue-400 flex rounded-xl p-6 lg:p-6 pt-0 lg:pt-0 relative">
                    <img
                      src={worklist.image}
                      alt={worklist.title}
                  ...
                  <div className="p-6 lg:p-12 mt-20">
                    ...
                    <p className="opacity-70 mb-4 text-black">{worklist.description}</p>
                    <button className="text-black px-5 py-2 rounded border border-blue-600 hover:bg-blue-600 hover:text-white transition duration-300 mt-6">
                      {worklist.title}
                    </button>
                  </div>
                </div>
